%% Run Gallant Lab's motion energy model
% Modified by Sam Nastase

%% Setup
addpath('/home/nastase/motion_energy_matlab')
addpath('/home/nastase/motion_energy_matlab/utils')
addpath('/home/nastase/social_actions/motion')
